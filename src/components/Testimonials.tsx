...
const Testimonials = () => {
  ...
  return (
    <section style={{ backgroundColor: 'hsl(218 18% 9%)' }} className="py-16 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {getVisibleTestimonials().map((testimonial, index) => (
                <Card
                  ...
                  className={`bg-ivory/5 border-ivory/10 transition-all duration-500 ${
                ...
                >
                  <CardContent className="p-6">
                    ...
                    {/* Testimonial Text */}
                    <blockquote className="text-ivory/80 text-center mb-6 leading-relaxed italic text-sm">
                      "{testimonial.text}"
                    </blockquote>

                    {/* Customer Info */}
                    <div className="text-center">
                      <div className="font-semibold text-gold mb-1 text-sm">
                        {testimonial.name}
                      </div>
                      <div className="text-xs text-ivory/60 mb-2">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mt-12">
          <div className="text-center">
            <div className="text-3xl font-bold text-gold mb-1">10,000+</div>
            <div className="text-sm text-ivory/70">Happy Customers</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-gold mb-1">30+</div>
            <div className="text-sm text-ivory/70">Years Experience</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-gold mb-1">99%</div>
            <div className="text-sm text-ivory/70">Customer Satisfaction</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-gold mb-1">₹50Cr+</div>
            <div className="text-sm text-ivory/70">Gold Transacted</div>
          </div>
        </div>
      </div>
    </section>
