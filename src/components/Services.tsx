      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {services.map((service, index) => (
            <Card key={index} className="card-luxury group hover:shadow-elevated transition-all duration-300">
              ...
              <CardContent className="text-center">
                  ...
                  <ul className="space-y-2">
                    {service.features.map((feature, idx) => (
                      <li key={idx} className="text-sm text-foreground flex items-center justify-center">
                        <div className="w-1 h-1 bg-gold rounded-full mr-2 flex-shrink-0" />
                        {feature}
                      </li>
                    ))}
                  </ul>
                ...
                <Button variant="outline-gold" className="group-hover:bg-gold group-hover:text-charcoal transition-all w-full">
                  {service.cta}
        ...
        <div className="card-dark p-8 lg:p-12 rounded-2xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-title font-playfair text-ivory mb-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
                {goldSavingsScheme.benefits.map((benefit, index) => (
                  <div key={index} className="flex items-center">
                    ...
                    <span className="text-sm text-ivory/90">{benefit}</span>
                  </div>
                ))}
              </div>
