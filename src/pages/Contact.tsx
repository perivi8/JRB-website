...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      primary: 'JRB Gold Private Limited',
      secondary: 'No: 1539, 1st Floor, Soundar Complex, Vellore Road, Near Anna Arch, Thiruvannamalai, Tamil Nadu - 606604',
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Yes, we provide secure home delivery for purchases above ₹25,000 within Thiruvannamalai and nearby areas. Delivery charges may apply for other locations.'
    },
    {
                    ...
                    <div className="h-64 bg-gradient-to-br from-gold/20 to-gold/5 flex items-center justify-center rounded-lg">
                      <div className="text-center">
                        ...
                        <p className="text-muted-foreground text-sm">
                          ...
                          Vellore Road, Near Anna Arch<br />
                          Thiruvannamalai, Tamil Nadu - 606604
                        </p>
